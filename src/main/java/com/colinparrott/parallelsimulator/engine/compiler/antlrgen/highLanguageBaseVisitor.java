...
public class highLanguageBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements highLanguageVisitor<T>
{
     ...
     */
    @Override
    public T visitProgram(highLanguageParser.ProgramContext ctx)
    {
     ...
     */
    @Override
    public T visitValueExp(highLanguageParser.ValueExpContext ctx)
    {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitAdditionExp(highLanguageParser.AdditionExpContext ctx)
    {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitSubExp(highLanguageParser.SubExpContext ctx)
    {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitMultExp(highLanguageParser.MultExpContext ctx)
    {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitDivExp(highLanguageParser.DivExpContext ctx)
    {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitSingleValue(highLanguageParser.SingleValueContext ctx)
    {
        return visitChildren(ctx);
    }
}