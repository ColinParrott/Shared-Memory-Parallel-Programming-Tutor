...
public class SetIfGreaterThan extends Instruction
{
    ...
    public SetIfGreaterThan(int setRegister, int firstRegister, int secondRegister)
    {
        super(InstructionKeyword.SGT);
