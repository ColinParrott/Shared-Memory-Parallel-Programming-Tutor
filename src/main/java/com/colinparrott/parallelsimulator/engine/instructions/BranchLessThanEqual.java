...
public class BranchLessThanEqual extends Instruction
{
    private int firstRegisterNumber;
    private int secondRegisterNumber;
    private String label;

    public BranchLessThanEqual(int firstRegisterNumber, int secondRegisterNumber, String label)
    {
        super(InstructionKeyword.BLE);
    ...
    {
        // If first register less than or equal to second need to move instruction pointer
