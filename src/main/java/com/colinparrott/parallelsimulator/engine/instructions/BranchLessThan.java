...
public class BranchLessThan extends Instruction
{
    private int firstRegisterNumber;
    private int secondRegisterNumber;
    private String label;

    public BranchLessThan(int firstRegisterNumber, int secondRegisterNumber, String label)
    {
        super(InstructionKeyword.BLT);
    ...
    {
        // If first register less than second need to move instruction pointer
