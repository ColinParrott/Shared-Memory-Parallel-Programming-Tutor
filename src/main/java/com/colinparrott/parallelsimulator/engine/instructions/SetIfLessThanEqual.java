...
public class SetIfLessThanEqual extends Instruction
{
    ...
    public SetIfLessThanEqual(int setRegister, int firstRegister, int secondRegister)
    {
        super(InstructionKeyword.SLE);
