...
public class SetIfGreaterThanEqual extends Instruction
{
    ...
    public SetIfGreaterThanEqual(int setRegister, int firstRegister, int secondRegister)
    {
        super(InstructionKeyword.SGE);
