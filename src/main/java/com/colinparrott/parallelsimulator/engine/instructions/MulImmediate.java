...
public class MulImmediate extends Instruction
{
    ...
    public MulImmediate(int destRegisterNumber, int sourceRegisterNumber, int constant) {
        super(InstructionKeyword.MULI);
