...
/**
 * This class provides an empty implementation of {@link SingleProgramLanguageListener},
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
public class SingleProgramLanguageBaseListener implements SingleProgramLanguageListener
{
	/**
	 * {@inheritDoc}
	 *
